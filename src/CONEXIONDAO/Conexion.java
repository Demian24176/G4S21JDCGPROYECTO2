...
public class Conexion {
    ...
    private void Abrir(){
        ...
        String url="jdbc:mysql://localhost:3306/spartan?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDateimeCode=false&serverTimezone=UTC";
         try {
   ...
   try{
        ...
        while(rs.next()){
            datos = new Datos(rs.getNString("nombre"),rs.getString("telefono"),rs.getString("celular"),rs.getString("direccion"),rs.getInt("id"));
